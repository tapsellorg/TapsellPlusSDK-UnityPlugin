    ...
    public class TapsellPlus
    {
        ...
        private static IEnumerator LoadTapsellNativeAdComponents(TapsellPlusNativeAd tapsellPlusNativeAd)
        {
            ...
            if (tapsellNativeAd.iconUrl != null && !tapsellNativeAd.iconUrl.Equals(""))
            {
                ...
                if (wwwIcon.result is UnityWebRequest.Result.ConnectionError or UnityWebRequest.Result.ProtocolError)
#else
...
#if UNITY_2020_3_OR_NEWER
                if (wwwPortrait.result is UnityWebRequest.Result.ConnectionError or UnityWebRequest.Result
                    .ProtocolError)
#else
...
#if UNITY_2020_3_OR_NEWER
                if (wwwLandscape.result is UnityWebRequest.Result.ConnectionError or UnityWebRequest.Result
                    .ProtocolError)
#else
