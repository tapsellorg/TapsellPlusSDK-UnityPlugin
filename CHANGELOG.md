...
- Update EDM4U to `1.2.186`.
- Update working unity editor to `2021.3.45f2`.
- Update google-mobile-ads to `8.7.0`.
- Clean up published package from unnecessary files.
- Added required `*.meta` files in published packages. [#6](https://github.com/tapsellorg/TapsellPlusSDK-UnityPlugin/issues/6)
